    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            ...
            Obx(() => Text(
                  "${cartController.demoCarts.length} items",
      ...
      body: Padding(
        ...
        child: Obx(() => ListView.builder(
              itemCount: cartController.demoCarts.length,
              itemBuilder: (context, index) => Padding(
                padding: const EdgeInsets.symmetric(vertical: 10),
                child: Dismissible(
                  key: Key(
                      cartController.demoCarts[index].product.id.toString()),
                  ...
                  child: CartCard(cart: cartController.demoCarts[index]),
                ),
              ),
            )),
      ),
