...
class Categories extends StatelessWidget {
  ...
  final List<Map<String, String>> demoCategories = [
    {"name": "All Categories"},
    {"name": "Man's", "svgSrc": "assets/icons/Man.svg"},
    {"name": "Woman’s", "svgSrc": "assets/icons/Woman.svg"},
  ];
      ...
      child: Row(
        children: List.generate(
          demoCategories.length,
              (index) => Obx(() {
            final isActive =
                controller.selectedCategory.value == demoCategories[index]["name"];
            return Padding(
              padding: EdgeInsets.only(
                left: index == 0 ? defaultPadding : defaultPadding / 2,
              ...
              child: CategoryBtn(
                ...
                isActive: isActive,
                press: () {
                  controller.changeCategory(demoCategories[index]["name"]!);
                },
              ),
            );
          }),
